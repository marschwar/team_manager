...
class PracticesControllerTest < ActionController::TestCase
  ...
  test "should get index" do
    get :index, team_id: @event.team_id
    assert_response :success
    assert_not_nil assigns(:events)
  end

  test "should get new" do
    get :new, team_id: @event.team_id
    assert_response :success
  end

  test "should create event" do
    assert_difference('Event.count') do
      post :create, team_id: @event.team_id,
  ...
  test "should show event" do
    get :show, team_id: @event.team_id, id: @event
    assert_response :success
  end

  test "should get edit" do
    get :edit, team_id: @event.team_id, id: @event
    assert_response :success
  end
  ...
  test "should destroy event" do
    assert_difference('Event.count', -1) do
      delete :destroy, team_id: @event.team_id, id: @event
    end
